...
function otw_pfl_admin_notice(){
  ...
  if (is_admin() && $typenow=='otw-portfolio') {
      ?>
      <div class="updated">
          <p>OTW Portfolio Light: <a href="http://otwthemes.com/online-documentation-otw-portfolio-light-plugin/?utm_source=wp.org&amp;utm_medium=admin&amp;utm_content=docs&amp;utm_campaign=otw-p" target="_blank">Documentation page</a> and <a href="http://otwthemes.com/demos/1ts/redirect.php?item=OTW%20Portfolio%20Light&utm_source=wp.org&amp;utm_medium=admin&amp;utm_content=demo&amp;utm_campaign=otw-p" target="_blank">Demo site</a></p>
          <p><strong>Want tones of more options and premium support?</strong> Upgrade to the Pro version of the <a href="http://codecanyon.net/item/portfolio-manager-pro-wordpress-responsive-portfolio-gallery/16644715?ref=OTWthemes&utm_source=wp.org&utm_medium=admin&utm_content=upgrade&utm_campaign=pm" target="_blank">Portfolio Manager Pro for WordPress</a> | <a href="http://otwthemes.com/demos/1ts/redirect.php?item=Portfolio%20Manager%20Pro&utm_source=wp.org&utm_medium=admin&utm_content=upgrade&utm_campaign=pm">Demo site</a>.</p>
		  <p>Get some more awesome FREE plugins: <a href="http://otwthemes.com/product/portfolio-manager-lite-wordpress-plugin/?utm_source=wp.org&utm_medium=admin&utm_content=otherfreep&utm_campaign=otw-p" target="_blank">Portfolio Manager</a>, <a href="http://otwthemes.com/product/widgetize-pages-light-wordpress-plugin?utm_source=wp.org&utm_medium=admin&utm_content=otherfreep&utm_campaign=otw-p" target="_blank">Widgetize Pages</a>, <a href="http://otwthemes.com/product/content-manager-light-wordpress-plugin?utm_source=wp.org&utm_medium=admin&utm_content=otherfreep&utm_campaign=otw-p" target="_blank">Content Manager</a> </p>
      </div>
     <?php }
 }
